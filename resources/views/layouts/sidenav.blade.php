...
<div class="sidebar" id="sidebar">
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: 100%; height: 629px;"><div class="sidebar-inner slimscroll" style="overflow: hidden; width: 100%; height: 629px;">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul id="navi">
                ...
                <li class="">
                    <a href="doctor-schedule.html"><i class="fa fa-calendar-check-o"></i><span>Doctor
                            Schedule</span></a>
                </li>
                <li class="">
                ...
                <li>
                    <a href="assests.html"><i class="fa fa-cube"></i> <span>Assets</span></a>
                </li>
                <li>
    ...
    </div><div class="slimScrollBar" style="background: rgb(204, 204, 204); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 318.295px;"></div><div class="slimScrollRail" style="width: 7px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
</div>
@show