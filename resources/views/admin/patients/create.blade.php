                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select select2-hidden-accessible" tabindex="-1"
                                                ...
                                                dir="ltr" style="width: 100%;"><span class="selection"><span
                                                        ...
                                                        aria-labelledby="select2-8agv-container"><span
                                                            class="select2-selection__rendered" id="select2-8agv-container"
                                                            title="USA">USA</span><span class="select2-selection__arrow"
                                                            role="presentation"><b
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select select2-hidden-accessible" tabindex="-1"
                                                ...
                                                dir="ltr" style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single" role="combobox"
                                                        aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                        aria-labelledby="select2-b92x-container"><span
                                                            class="select2-selection__rendered" id="select2-b92x-container"
